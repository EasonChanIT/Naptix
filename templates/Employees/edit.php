    ...
    <div class="col-12 col-md-6">
        ...
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit <?= h($employee->first_name) ?> Details</h3>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 offset-md-1 col-12">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo $this->Form->control('username', ['class'=>'form-control form-control-user', 'placeholder'=>'Enter username (Optional)', 'label' => 'Username']);
                                            ?>
