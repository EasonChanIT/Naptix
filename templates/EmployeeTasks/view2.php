        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table border="0" class="my_table">
                    ...
                    <tr>
                        <td width="10%"><?= __('Employee Name') ?></td>
                    ...
                    <tr>
                        <td width="10%"><?= __('Approval Status') ?></td>
                        <td width="40%"><div class="bk"><?= $employeeTask->approval_status ? __('Yes') : __('No'); ?></div></td>
                        <td width="10%"><?= __('No Charge Status') ?></td>
                        <td width="40%"><div class="bk"><?= $employeeTask->no_charge_status ? __('Yes') : __('No'); ?></div></td>
                    </tr>
                    <tr>
                        <td width="10%"><?= __('Invoice Status') ?></td>
                        <td width="40%"><div class="bk"><?= $employeeTask->invoice_status ? __('Yes') : __('No'); ?></div></td>
                    </tr>
                    <tr>
                        <td colspan="1"><?= __('Task Name') ?></td>
                        <td colspan="3"><div class="bk" style="width:50%;"><?= h($employeeTask->task->task_name) ?></div></td>
                    </tr>
                    <tr>
